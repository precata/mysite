...
return array(
    ...
    'create_only_logged' => 'Create planets can only registered users',
    'delete_only_logged' => 'Delete planets can only registered users',
    'edit_only_logged' => 'Edit planets can only registered users',
